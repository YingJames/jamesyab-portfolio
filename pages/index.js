      ...
      <main className={styles.main}>
        ...
        <section className={styles["section--container"]}>
          ...
          <article
            ...
            <a href="https://github.com/YingJames/">
              <Image
                className="w-28 h-28 mb-4 rounded-full border-4 border-black"
              ...
              <div className="inline-flex">
                <Image className="w-7 h-7 text-gray-500 dark:text-gray-400 mr-2" src={githubLogo} alt={"github logo"}/>
                <h5 className="text-2xl font-semibold tracking-tight text-gray-900 dark:text-white">Check out my Github!</h5>
              </div>
            </a>
            ...
            <a href="https://github.com/YingJames/" target="_blank"
          ...
          <section className="grid md:grid-cols-2 gap-4 justify-items-center mt-4">
            <article
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">As a member of the multidisciplinary
                  team
            ...
            <article
              ...
              <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                  Force Graph Generator is a project that allows users to create a force directed graph using a textbox
                  as
                  user input,
